...
class ObstacleLayoutTest(unittest.TestCase):
    ...
    def test_planning_dimensions_match_mjcf(self):
        ...
        for index in range(1, 6):
            ...
            self.assertIn("euler", body.attrib)
            self.assertEqual(geom.attrib.get("euler"), "0 0 0")

        obstacle_ply = TASK_DIR / "models" / "3dgs" / OBSTACLE_GS_PLY
        self.assertTrue(obstacle_ply.is_file(), obstacle_ply)
